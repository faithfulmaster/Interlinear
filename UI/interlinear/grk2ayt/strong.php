...
echo "<tr valign=\"top\"><td>Strong#</td><td>:</td><td><big>$strong // $word</big></td></tr>\n";
echo "<tr valign=\"top\"><td>Orig</td><td>:</td><td><b>{$greek['kind']}</b> // {$greek['origin']}</td></tr>\n";
echo "<tr valign=\"top\"><td>NASB</td><td>:</td><td>==>{$nasb['gloss']}</td></tr>\n";
echo "<tr valign=\"top\"><td>AV={$greek['count']}</td><td>:</td><td>==>{$greek['av']}</td></tr>\n";

echo "<tr valign=\"top\"><td>Definition</td><td>:</td><td><pre>{$greek['definition']}</pre></td></tr>\n";
echo "<tr valign=\"top\"><td>NASB</td><td>:</td><td>&nbsp;&nbsp;{$nasb['def']}</td></tr>\n";
echo "</table>\n";
echo "</td></tr>\n";    
echo "</table>\n";
